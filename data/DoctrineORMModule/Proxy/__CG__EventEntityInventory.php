 ...
 */
class Inventory extends \Event\Entity\Inventory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'category', 'description', 'user', 'inventorylog', 'stock', 'type');
        }
    ...
    public function getInventoryLog()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInventoryLog', array());

        return parent::getInventoryLog();
    }
